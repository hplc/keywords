...
<p class="footer" id="footer">&nbsp;</p>
   ...
   <? 
     ...
     $sql="select * from websites ORDER BY id DESC ";           		 //sql语句 
...
<table width='60%' id='cow' cellspacing='0' cellpadding='0'>
  <tr>
    ...
    <tr bgcolor='#DBE6F5'>
      <td><span style='float:left; text-align:left'><b>网址：<font color=blue><a href='websites.php?id=".$rs->id."' target='_blank' title='$rs->website 的搜索引擎收录和反链情况'>$rs->website</a></font></b></span><span style='float: right; text-align:right' title='".$rs->time."'><b>发布时间：</b>$rs->time&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
   </tr>
   </table> 
  </td>
  </tr>
...
"; 
	...
	<table width='60%' cellspacing='1' cellpadding='2'>
    <tr bgcolor='#DBE6F5'>
      <td><span style='float:right; text-align:right'><font color=#666666>总共有&nbsp;<b>$amount</b>&nbsp;个网址。<font></span></td>
   </tr>
   </table>";
       mysql_close();
  ?>
